...
const props = defineProps({
  productDetail: {
    ...
    default: () => ({
      ...
      onSale: false, // FIXME: 測試時用，之後要改成 false
    }),
  },
});
...
<template>
  <section
    class="group w-full min-w-[340px] max-w-[650px] rounded-2xl px-5 drop-shadow-xl"
    style="background: linear-gradient(180deg, #000 40%, #fff 40%)"
  >
    <div class="flex flex-row gap-5">
      <div class="relative my-5 basis-2/5">
        <div
          class="m-4 h-full w-full bg-cover bg-center bg-no-repeat"
      ...
      <div class="basis-3/5">
        <div
          class="box-border flex h-2/5 flex-col justify-between py-5 text-white"
        >
        ...
        <div class="box-border flex h-3/5 flex-col justify-end py-5">
          <div class="mx-4 mt-6 grid grid-cols-3 gap-4">
            <div
